...
<?php include 'sidebar.php'; ?>
    ...
    <script src="<?php echo base_url('js/bootstrap-checkbox-radio.js'); ?>"></script>

    <!--  Charts Plugin -->
    <script src="<?php echo base_url('js/chartist.min.js'); ?>"></script>
    ...
    <script src="<?php echo base_url('js/paper-dashboard.js'); ?>"></script>
