                                        ...
                                        <?php 
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo base_url('index.php/Welcome/editmas/').$u->no_urut; ?>" class="btn btn-primary">
                                                    <i class="fa fa-edit"></i></a>
                                                <a href="<?php echo base_url('index.php/Welcome/delmasuk/').$u->no_urut; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                            </td>
                                             <?php } ?>
                                         </tr>
                                    </tbody>
